...
from util import train, validate, test
from model import RE2

def model_train_validate_test(args, train_df, dev_df, test_df, embeddings_file, vocab_file, target_dir, mode,
         max_length=50,
         epochs=50,
         batch_size=128,
         lr=0.0005,
    ...
    if(embeddings_file is not None):
        ...
        embeddings = None
    model = RE2(args, embeddings=embeddings, device=device).to(device)
...
def model_load_test(args, test_df, vocab_file, embeddings_file, pretrained_file, 
                    test_prediction_dir, test_prediction_name, mode, max_length=50, gpu_index=0, batch_size=128):
